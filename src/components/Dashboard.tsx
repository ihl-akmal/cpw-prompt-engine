            ...
            <AnimatePresence>
                ...
                >
                    <div className="text-center">
                        ...
                        <p className="text-gray-500 mt-2">Jadilah Pro dan buka semua fitur tanpa batas.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div className="border border-gray-200 rounded-xl p-8 flex flex-col bg-white shadow-sm">
                            ...
                            <ul className="space-y-4 mt-8 text-gray-700 flex-grow">
                                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-rose-500" /><span>5x Prompt Engine per hari</span></li>
                                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-rose-500" /><span>3x Penggunaan Brand Voice per hari</span></li>
                                <li className="flex items-center gap-3"><XCircle className="w-5 h-5 text-gray-400" /><span>Fitur Unduh & Refine Terbatas</span></li>
                        ...
                        <div className="border-2 border-rose-500 rounded-xl p-8 flex flex-col relative bg-white shadow-lg">
                            ...
                            <ul className="space-y-4 mt-8 text-gray-700 flex-grow">
                                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-rose-500" /><span>10x Prompt Engine per hari</span></li>
                                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-rose-500" /><span>5x Penggunaan Brand Voice per hari</span></li>
                                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-rose-500" /><span>Fitur Unduh & Refine Tanpa Batas</span></li>
                                <li className="flex items-center gap-3"><CheckCircle className="w-5 h-5 text-rose-500" /><span>Dukungan Prioritas</span></li>
                            </ul>
                            <button 
                                onClick={handleUpgrade} 
                                disabled={isUpgrading}
                                className={cn("w-full mt-8 py-3 px-6 bg-rose-200 hover:bg-rose-300 text-rose-800 font-bold rounded-lg transition-all flex items-center justify-center gap-2", {
                     ...
                     <div className="text-center mt-8">
                        <button onClick={() => setShowPricing(false)} className="text-gray-500 hover:text-gray-800 transition-colors">
        ...
        <div className="space-y-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div className='flex items-center gap-4'>
                     <img src={userProfile.photoURL || undefined} alt={userProfile.name || 'User'} className='w-12 h-12 rounded-full border-2 border-rose-500' />
                    <div>
                        <h1 className="text-xl font-bold text-gray-800">Welcome, {userProfile.name}</h1>
                        {userProfile.isPro ? (
                            ...
                            <p className='text-gray-500 text-sm'>You are on the <span className='font-bold text-rose-600'>Free Plan</span>. </p>
                        )}
                    </div>
                </div>
                <div className='flex items-center gap-2'>
                    {!userProfile.isPro && (
                        <button 
                            ...
                            className='px-4 py-2 bg-rose-200 hover:bg-rose-300 text-rose-800 font-bold rounded-lg transition-all text-sm flex items-center gap-2'
                        >
                            Upgrade to Pro
                            <ExternalLink className="w-4 h-4" />
                        </button>
                    )}
                    <button onClick={handleLogout} className='px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition-colors text-sm'>
                        Logout
                    </button>
                </div>
            </div>
